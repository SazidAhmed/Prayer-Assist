...
useSeoMeta({
  ...
  description:
    "Track your daily prayers with precision. A phase-based Rakat counter for all 5 daily prayers.",
});
      ...
      <div class="flex flex-col h-full">
          ...
          >
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div
                  class="w-10 h-10 rounded-xl bg-amber-500/20 flex items-center justify-center animate-pulse"
                >
        ...
        <header class="pt-14 pb-6 px-6">
          <div class="flex items-center justify-between mb-6">
            <div>
              <p class="text-white/40 text-xs uppercase tracking-[0.25em] mb-1">
                Bismillah
              </p>
          ...
          <div class="w-full h-1 bg-white/10 rounded-full overflow-hidden">
            <div
              ...
              :style="{
                width: `${store.prayers.length > 0 ? (store.completedPrayersCount / store.prayers.length) * 100 : 0}%`,
              }"
            />
          </div>
        </header>
        ...
        <!-- Prayer cards -->
        <div
          class="flex-1 px-4 pb-4 flex flex-col gap-3 overflow-y-auto custom-scrollbar"
        >
          <button
            v-for="prayer in store.prayers"
        ...
        <div v-if="store.settings.travelerMode" class="px-4 pb-2 flex-shrink-0">
          ...
          >
            ...
            <span class="text-amber-400/80 text-xs"
              >Traveler Mode: Fardh prayers shortened</span
            >
          </div>
        </div>
        ...
        <nav class="px-4 pb-8 pt-2 flex-shrink-0">
          ...
          >
            ...
            <button
              ...
              :class="
                showPlans ? 'text-white' : 'text-white/30 hover:text-white/60'
              "
